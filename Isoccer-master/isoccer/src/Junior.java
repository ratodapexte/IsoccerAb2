public class Junior extends FanSupporters{
    private double contribuition;
    private int paymentDay;

    public Junior(double contribuition, int paymentDay, String addres, String cpf, String name, String phone, String status)
    {
